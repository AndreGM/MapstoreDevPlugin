...
module.exports = require('./MapStore2/build/buildConfig')(
    {
        'MapStoreDevPlugin': path.join(__dirname, "js", "app"),
        'MapStoreDevPlugin-embedded': path.join(__dirname, "js", "embedded"),
        'MapStoreDevPlugin-api': path.join(__dirname, "MapStore2", "web", "client", "product", "api"),
    ...
    [
        ...
        new HtmlWebpackPlugin({
            ...
            chunks: ['MapStoreDevPlugin-embedded'],
            publicPath: 'dist/',
            inject: "body",
            hash: true,
